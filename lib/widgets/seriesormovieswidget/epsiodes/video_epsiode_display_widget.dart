...
// class VideoEpsisodesWidget extends StatefulWidget {
//   final String _urlVideo;

//   const VideoEpsisodesWidget({Key key, String urlVideo})
//       : _urlVideo = urlVideo,
//         super(key: key);

//   @override
//   _VideoEpsisodesWidgetState createState() => _VideoEpsisodesWidgetState();
// }

// class _VideoEpsisodesWidgetState extends State<VideoEpsisodesWidget> {
...
//                                 // SelectedTopicSeriesOrMovie(type: 'series',),
//                           ),
//                         );
//                       },
//                     );
